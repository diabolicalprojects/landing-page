            ...
            <div className="max-w-6xl mx-auto px-6 relative z-10">
                <div className="text-center max-w-2xl mx-auto mb-14">
                    <div className="inline-block px-3 py-1 bg-white/5 rounded-full mb-4">
                        <span className="text-[8px] uppercase tracking-[0.4em] text-white/40 font-black">Prueba Social</span>
                    </div>
                    <h2 className="text-2xl md:text-4xl font-title uppercase tracking-tighter mb-3">Casos de Éxito</h2>
                    <p className="text-white/30 uppercase tracking-[0.3em] text-[9px] font-bold">Métricas Reales e Impacto de Negocio</p>
                </div>
                        ...
                        <div key={i} className="glass-card p-8 rounded-3xl border-white/5 hover:border-white/15 transition-all group flex flex-col justify-between min-h-[320px]">
                            <div className="space-y-4">
                                <div className="flex justify-between items-start">
                                    <span className="text-[10px] font-mono tracking-widest text-white/40 uppercase">{c.client}</span>
                                ...
                                <p className="text-xs text-white/40 leading-relaxed font-light">{c.detail}</p>
                            </div>
                            <div className="border-t border-white/5 pt-4 mt-6 flex items-center gap-2">
                                ...
                                <span className="text-[10px] font-mono text-white/60 uppercase tracking-wider leading-snug">{c.result}</span>
                            </div>
                        </div>
                    ))}
                </div>
